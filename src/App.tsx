        ...
        <header className="h-16 bg-white border-b border-slate-200/80 px-6 flex items-center justify-between shrink-0 print:hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              {showProfileDropdown && (
                <div className="absolute right-0 mt-1 w-64 bg-white border border-slate-100 rounded-xl shadow-lg py-2 z-50 text-xs">
                  ...
                  <div className="max-h-48 overflow-y-auto">
                    {officers.map((off) => (
                      ...
                      >
                        ...
                        {currentOfficer === off.name && <span className="text-indigo-600 font-bold shrink-0 ml-1">✓</span>}
                      </button>
                    ))}
                  </div>
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 hover:bg-indigo-50 text-indigo-600 font-bold flex items-center gap-2 cursor-pointer transition-colors"
                  >
